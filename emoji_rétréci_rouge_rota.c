...
void deplacement_choix_rota(int tab[colo][lign],int tab_choix_rota[1],int ch_choix_rota,int *coo_choix_rota,int *play_choix_rota,int dim,int coo_y,int coo_x){
    switch (ch_choix_rota){
        case KEY_UP:
            if((*coo_choix_rota)>0){
                ...
                tab_choix_rota[1]=' ';
                (*coo_choix_rota)--;
                tourner(tab,coo_y,coo_x,(*coo_choix_rota),dim);
                tourner(tab,coo_y,coo_x,(*coo_choix_rota),dim);
            }
            break;
        case KEY_DOWN:
    ...
    while (!gagnant) {
        ...
        if(jouer_coup(tableau,co_jeton,jeton)){
            ...
            while(play_choix_rota){
                ...
                deplacement_choix_rota(tableau,tab_choix_rota,ch_choix_rota,&coo_choix_rota,&play_choix_rota,dim,coo_y,coo_x);
                //tourner(tableau,coo_y,coo_x,coo_choix_rota,dim);
