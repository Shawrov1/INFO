...
void affichage_choix_rota(int tab_choix_rota[1],int tableau[lign][colo],int x,int y,int xx){
    ...
    while (!gagnant) {
        ...
        if(jouer_coup(tableau,co_jeton,jeton)){
            ...
            while(play_choix_rota){
                affichage_rota(tableau,coo_x,coo_y,dim);
                printw("\n");
                affichage_choix_rota(tab_choix_rota,tableau,coo_y,coo_x,dim);
                printw("\n");
